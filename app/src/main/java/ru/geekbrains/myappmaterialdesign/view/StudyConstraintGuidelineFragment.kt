...
import ru.geekbrains.myappmaterialdesign.databinding.StudyFragmentConstraintGuidelineBinding

class StudyConstraintGuidelineFragment : Fragment() {

    private var _binding: StudyFragmentConstraintGuidelineBinding? = null
    private val binding get() = _binding!!

    companion object {
        @JvmStatic
        fun newInstance() = StudyConstraintGuidelineFragment()
    }
    ...
    override fun onCreateView(
        ...
        _binding = StudyFragmentConstraintGuidelineBinding.inflate(inflater, container, false)
        return binding.root
    }
